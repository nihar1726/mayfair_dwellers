<!-- Removed the include statement to prevent infinite loop -->

<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Bridgerton Stories</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <header>
        <div class="logo">
            <h1><a href="index.php">Bridgerton Stories</a></h1>
        </div>
        <nav class="navbar">
            <ul>
                ...
                <li><a href="/characters/penelope.php">Penelope</a></li>
                <li><a href="/characters/marina.php">Marina</a></li>
                <li><a href="/characters/simon.php">Simon</a></li>
                <li><a href="/characters/edwina.php">Edwina</a></li>
                <li><a href="/characters/philippa.php">Philippa</a></li>
                <li><a href="/characters/prudence.php">Prudence</a></li>
            </ul>
        </nav>
    </header>